...
/**
* event_service/EventHelper.java .
...
{
  private static String  _id = "IDL:event_service/Event:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (event_service.EventHelper.id (), "Event", __typeCode);
    }
    return __typeCode;
  }
