...
/**
* event_service/ChannelFactoryPOA.java .
...
public abstract class ChannelFactoryPOA extends org.omg.PortableServer.Servant
 implements event_service.ChannelFactoryOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // event_service/ChannelFactory/create
       {
         try {
         ...
         } catch (event_service.NameAlreadyInUse $ex) {
           out = $rh.createExceptionReply ();
           event_service.NameAlreadyInUseHelper.write (out, $ex);
         }
         break;
       }

       case 1:  // event_service/ChannelFactory/destroy
       {
         try {
           String name = in.read_string ();
           this.destroy (name);
           out = $rh.createReply();
         } catch (event_service.InvalidName $ex) {
           out = $rh.createExceptionReply ();
           event_service.InvalidNameHelper.write (out, $ex);
         }
         break;
       }
  ...
  private static String[] __ids = {
    "IDL:event_service/ChannelFactory:1.0"};
