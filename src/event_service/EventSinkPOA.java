...
/**
* event_service/EventSinkPOA.java .
...
public abstract class EventSinkPOA extends org.omg.PortableServer.Servant
 implements event_service.EventSinkOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // event_service/EventSink/push
       {
         org.omg.CORBA.Any ev = event_service.EventHelper.read (in);
         this.push (ev);
         out = $rh.createReply();
         break;
       }

       case 1:  // event_service/EventSink/disconnect
       {
         this.disconnect ();
         out = $rh.createReply();
         break;
  ...
  private static String[] __ids = {
    "IDL:event_service/EventSink:1.0"};
